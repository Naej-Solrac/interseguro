...
// @Description  Recibe una matriz, realiza factorizacion QR usando el algoritmo de Gram-Schmidt, y retorna matrices Q y R con estadisticas. Ejemplo request: {"data":[[12,3],[4,5],[6,7]]}
...
// @Success      200 {object} MatrixProcessSuccessResponse "Factorizacion QR completada con estadisticas"
// @Failure      400 {object} ErrorResponse "Formato JSON invalido o error de validacion"
// @Failure      401 {object} ErrorResponse "Token JWT invalido, expirado o no proporcionado"
// @Failure      500 {object} ErrorResponse "Error interno al procesar la matriz"
